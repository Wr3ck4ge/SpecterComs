...
pub fn converter(
    ...
    input: ::util::format::Pixel,
    output: ::util::format::Pixel,
) -> Result<scaling::Context, ::Error> {
    scaling::Context::get(
        input,
        width,
...
#[inline]
pub fn resampler(
    (in_format, in_layout, in_rate): (::util::format::Sample, ::ChannelLayout, u32),
    (out_format, out_layout, out_rate): (::util::format::Sample, ::ChannelLayout, u32),
